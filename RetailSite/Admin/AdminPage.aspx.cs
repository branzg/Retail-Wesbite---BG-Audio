...
namespace RetailSite.Admin
{
    public partial class AdminPage : System.Web.UI.Page
    {
        ...
        {
            using (var _db = new RetailSite.Models.ProductContext())
            {
        ...
        protected void TransactionLog_Click(object sender, EventArgs e)
        {
            Response.Redirect("TransactionLog.aspx");
