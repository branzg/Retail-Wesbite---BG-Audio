<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="RetailSite.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="RetailSite.Models.Product" 
    ...
    <asp:Button ID="TransactionLog" runat="server" Text="View" OnClick="TransactionLog_Click" CausesValidation="false"/>
</asp:Content>