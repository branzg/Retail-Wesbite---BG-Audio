...
public class NVPAPICaller
{
    ...
    public string APIUsername = "brandonrguild-facilitator_api1.gmail.com";
    private string APIPassword = "LJJJ4FTL25AJBHVU";
    private string APISignature = "A-2DKi.rzQlpXz1KzRFBGTB8LhOgAIhNFXhvSfVAwkxyTEnHAtYejAst";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:65430/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:65430/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "RetailSite Sample Application";
        ...
        using (RetailSite.Logic.ShoppingCartActions myCartOrders = new RetailSite.Logic.ShoppingCartActions())
        {
